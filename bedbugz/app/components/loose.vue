<template>
    <div class="win">
        ...
        <span class="win-heart win-heart--sml material-symbols-outlined"> heart_broken </span>

        <div class="win-title-pos-one">
            <h2 class="win-title font-semibold" data-text="Catch">
                Buzz
            </h2>
        </div>
        <div class="win-title-pos-two">
            <h2 class="win-title font-semibold" data-text="Catch">
                Off
            </h2>
        </div>
...
.win {
    ...
    &-heart {
        ...
        position: absolute;
        top: 20px;
        left: calc(25px + 140px);

        &--med {
            font-size: 40px;
            transform: rotate(15deg);
            top: -20px;
            left: calc(45px + 140px);
        }
        &--sml {
            font-size: 30px;
            transform: rotate(-20deg);
            top: -30px;
            left: calc(15px + 140px);
        }
    }
